...
#define SEVSEG_DIGIT_MODE       0   //1 or 0 digit input

#define SEVSEG_TIMER_MS	4
#define SEVSEG_BLINK_TIMER_SKIPS 75
...
#define SEVSEG_0_PIN_VALUE PB0
#define SEVSEG_1_PIN_VALUE PB1
#define SEVSEG_2_PIN_VALUE PB2
#define SEVSEG_3_PIN_VALUE PB3
#define SEVSEG_4_PIN_VALUE PB4
#define SEVSEG_5_PIN_VALUE PB5
#define SEVSEG_6_PIN_VALUE PB6
#define SEVSEG_7_PIN_VALUE PB7
...
#define SEVSEG_DIGIT_1_PIN_VALUE PC2
#define SEVSEG_DIGIT_2_PIN_VALUE PC3
#define SEVSEG_DIGIT_3_PIN_VALUE PC4
#define SEVSEG_DIGIT_4_PIN_VALUE PC5
