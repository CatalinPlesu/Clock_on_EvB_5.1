...
SevSegHandleConfig* SevSegCfgInitAndGet()
{
	SevSegHandleConfig sevseg_handle_config = {
		...
		.pinSegValue = { SEVSEG_0_PIN_VALUE, SEVSEG_1_PIN_VALUE, SEVSEG_2_PIN_VALUE, SEVSEG_3_PIN_VALUE,
			SEVSEG_4_PIN_VALUE, SEVSEG_5_PIN_VALUE, SEVSEG_6_PIN_VALUE, SEVSEG_7_PIN_VALUE, },
		...
		.pinDigitValue={ SEVSEG_DIGIT_1_PIN_VALUE, SEVSEG_DIGIT_2_PIN_VALUE, SEVSEG_DIGIT_3_PIN_VALUE,
			SEVSEG_DIGIT_4_PIN_VALUE, },
